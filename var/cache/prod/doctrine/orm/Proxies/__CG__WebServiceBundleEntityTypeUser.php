 ...
 */
class TypeUser extends \WebServiceBundle\Entity\TypeUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WebServiceBundle\\Entity\\TypeUser' . "\0" . 'id', '' . "\0" . 'WebServiceBundle\\Entity\\TypeUser' . "\0" . 'typeUser'];
        }
