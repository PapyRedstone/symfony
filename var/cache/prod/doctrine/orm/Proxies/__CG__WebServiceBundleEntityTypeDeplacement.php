 ...
 */
class TypeDeplacement extends \WebServiceBundle\Entity\TypeDeplacement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WebServiceBundle\\Entity\\TypeDeplacement' . "\0" . 'id', '' . "\0" . 'WebServiceBundle\\Entity\\TypeDeplacement' . "\0" . 'typeDeplacement', '' . "\0" . 'WebServiceBundle\\Entity\\TypeDeplacement' . "\0" . 'montant', '' . "\0" . 'WebServiceBundle\\Entity\\TypeDeplacement' . "\0" . 'created', '' . "\0" . 'WebServiceBundle\\Entity\\TypeDeplacement' . "\0" . 'updated'];
        }
