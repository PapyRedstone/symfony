 ...
 */
class Societe extends \WebServiceBundle\Entity\Societe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WebServiceBundle\\Entity\\Societe' . "\0" . 'id', '' . "\0" . 'WebServiceBundle\\Entity\\Societe' . "\0" . 'societe', '' . "\0" . 'WebServiceBundle\\Entity\\Societe' . "\0" . 'adresse', '' . "\0" . 'WebServiceBundle\\Entity\\Societe' . "\0" . 'ville'];
        }
