 ...
 */
class Service extends \WebServiceBundle\Entity\Service implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WebServiceBundle\\Entity\\Service' . "\0" . 'id', '' . "\0" . 'WebServiceBundle\\Entity\\Service' . "\0" . 'service'];
        }
