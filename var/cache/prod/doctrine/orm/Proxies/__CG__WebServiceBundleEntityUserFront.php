 ...
 */
class UserFront extends \WebServiceBundle\Entity\UserFront implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'id', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'nom', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'prenom', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'adresse', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'distanceInit', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'created', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'updated', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'service', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'societe', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'typeUser', '' . "\0" . 'WebServiceBundle\\Entity\\UserFront' . "\0" . 'ville'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserFront $proxy) {
